...
export default function Login() {
  ...
  return (
    <div
      className="login flex h-full max-h-screen flex-col overflow-hidden bg-gray-100 md:grid md:grid-cols-12"
      dir="ltr"
    >
      <div className="col-span-12 flex flex-col p-6 md:col-span-6 md:pl-12 md:pr-12">
        ...
        <form onSubmit={formik.handleSubmit}>
          <div className="mt-5 text-xs" dir="rtl">
            ...
            <div className="mb-5 flex w-full items-center justify-between space-y-2 text-xs">
        ...
        <div className="mt-10 flex items-center justify-center">
          <span className="text-[20px] text-black">
            ...
            <Link to="/Register" className="text-[20px] text-[#1976D2]">
              {" "}
              {t("create account")}
            </Link>
          </span>
      ...
      <div className="col-span-12 hidden h-[100vh] md:col-span-6 md:block">
        <Swiper
          ...
          className="mySwiperLoginRegister"
        >
          <SwiperSlide>
            <div className="relative">
              ...
              <div className="absolute left-1/2 top-[80%] -translate-x-1/2 -translate-y-1/2 text-center">
                <p className="text-center text-[24px] font-bold text-white">
                  لاَ أَعْلَمُ عِلْماً بَعْدَ الحَلاَلِ وَالحَرَامِ، أَنْبَلَ
                  مِنَ الطِّبِّ، إِلاَّ أَنَّ أَهْلَ الكِتَابِ قَدْ غَلَبُوْنَا
                  عَلَيْهِ
                </p>

                <span className="text-center text-[20px] font-bold text-white">
